# ESP32 IoT & WiFi Projects Library

Welcome to the ESP32 IoT and Wireless project library.

This directory contains step-by-step guides for building simulated circuits and running wireless networking code (WiFi, Web Servers, WebSockets, and MQTT) on the ESP32 using MbedO's interpreted runtime.
...
## 🌐 Default Wireless Config Parameters

To test networking features in MbedO's simulated local network environment, use:
- **SSID**: `MbedONet`
- **Password**: `password123`
- **Broker Endpoint**: `broker.hivemq.com` (port `1883`)
...
- WiFi connection wait loops use simple check states rather than infinite blocking loops.
