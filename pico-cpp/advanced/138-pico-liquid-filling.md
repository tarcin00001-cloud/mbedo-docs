# 138 - Pico Liquid Filling

Build an automated bottling control station that opens a solenoid valve and closes it when the liquid container reaches capacity.

## Goal
Learn how to use analog depth sensors (water level) and digital flow switches to control liquid dispensing valves and display filling metrics on an LCD screen.

## What You Will Build
An automatic liquid filling control panel:
...
- **16x2 I2C LCD (GP4, GP5)**: Displays filling progress (e.g. "Filling: 60%") and valve status.
...
- [130 - Pico Soil Irrigator](130-pico-soil-irrigator.md)
